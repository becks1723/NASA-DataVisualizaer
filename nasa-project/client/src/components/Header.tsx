    ...
    <HeaderContainer extend={extendedHeader} >
      <HeaderInnerContainer>
        ...
        <HeaderRight>
          <HeaderNavigationContainer>
            ...
            <StyledLink to="/Docs">API Docs</StyledLink>
            <ExpandBar
              onClick={() => {
      ...
      {/* {extendedHeader && ( */}
        <HeaderExtendedContainer ref={extendedContainerRef}>
          <StyledLinkWhileExtended to="/">Home</StyledLinkWhileExtended>
          <StyledLinkWhileExtended to="/Data">Data</StyledLinkWhileExtended>
          <StyledLinkWhileExtended to="/Analysis">
            Analysis
          </StyledLinkWhileExtended>
          <StyledLinkWhileExtended to="/Docs">API Docs</StyledLinkWhileExtended>
